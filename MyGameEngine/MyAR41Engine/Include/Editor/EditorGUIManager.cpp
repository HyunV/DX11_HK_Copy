...
void CEditorGUIManager::Render()
{
	...
	//Rendering, drawdata를 가져와서 렌더링 한다.
...
void CEditorGUIManager::SetFont(const std::string& Name, const char* FileName, float Size, int OverH, int OverV, float Spacing, const std::string& PathName)
{
